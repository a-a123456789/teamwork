...
- `BACKEND_WARMUP_SECONDS` (default `5`, global warmup pass across all backend scenarios before measurement)
- `BACKEND_SCENARIO_WARMUP_SECONDS` (default `0`, optional extra warmup before each individual scenario)
