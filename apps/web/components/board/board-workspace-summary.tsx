...
export function BoardWorkspaceSummary({ workspace }: BoardWorkspaceSummaryProps) {
  return (
    <section className="border-b border-line px-[1.25rem] py-[1rem]">
      <div className="flex flex-wrap items-center gap-x-[1.5rem] gap-y-[0.625rem]">
        <h2 className="truncate text-[1.875rem] font-semibold tracking-tight text-foreground">
          {workspace.name}
        </h2>
        <div className="flex flex-wrap items-center gap-[1.25rem] text-[0.9375rem] font-medium text-muted">
          <SummaryMetric
...
function MembersMetricIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-[1.25rem] w-[1.25rem]" fill="none" stroke="currentColor" strokeWidth="1.8">
