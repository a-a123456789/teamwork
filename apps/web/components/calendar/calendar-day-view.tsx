    ...
    <div className="px-6 pb-6">
      <div className="mx-auto flex max-w-[760px] flex-col gap-4">
        {tasks.length > 0 ? (
          ...
          <div className="rounded-[calc(var(--radius-panel)-0.15rem)] border border-dashed border-line bg-surface-muted/70 px-6 py-10 text-center text-sm leading-6 text-muted">
